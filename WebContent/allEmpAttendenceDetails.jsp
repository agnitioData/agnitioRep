...
<s:iterator value="empNameListVal">
<tr>
<td><s:property /></td>
</tr>
</s:iterator>
<s:iterator value="allEmpAttendenceResultValList">
<tr id="allEmpAttendenceResultValList">
...
$( "#example tbody #allEmpAttendenceResultValList #status" ).each( function( index ) {
	if ($(this).text()  == "A" ) {
	$( this ).css('color','red');
	}
	}); 
$( "#example tbody #allEmpAttendenceResultValList" ).each( function( index ) {
