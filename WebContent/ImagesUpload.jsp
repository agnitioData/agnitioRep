...
<s:form action="imageUploadAction" namespace="/" 
method="POST" enctype="multipart/form-data">

<s:file name="imagesUploadModel.image" label="Select a File to upload" size="40" />
<s:textfield name="imagesUploadModel.name"></s:textfield>
