...
<tbody>
<s:iterator value="empAttendenceDetailsList">
<tr id="empAttendenceDetailsList">
<td><s:property value="dateTime"/></td>
<td><s:property value="inTime"/></td>
<td><s:property value="outTime"/></td>
<td id="duration"><s:property value="duration"/> Hr</td>
...
$( "#example tbody #empAttendenceDetailsList #status" ).each( function( index ) {
	if ($(this).text()  == "A" ) {
	$( this ).css('color','red');
	}
	}); 
$( "#example tbody #empAttendenceDetailsList " ).each( function( index ) {
	
	if (($(this).find('#duration').text() < "08:59 Hr")&&($(this).find('#status').text() == "P")) {
	$( this ).find('#duration').css('color','red');
	}
	});
</script>
