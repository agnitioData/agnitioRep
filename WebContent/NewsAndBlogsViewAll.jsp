...
#mid-box2 .tab{width:100%; float:left; margin-bottom:10px; padding-bottom:10px; border-bottom:solid 1px #dedede;}
#mid-box2 .tab .date{width:9%; float:left; font-size:15px; color:#2e5b9e; line-height:18px; height:45px;}
#mid-box2 .tab .Category{width:9%; float:left; font-size:15px; color:#2e5b9e; line-height:18px; height:45px;}
#mid-box2 .tab .date p{font-size:14px; color:#333;}
#mid-box2 .tab .date-text{width:81%; font-size:15px; color:#403F3D; float:left; padding-bottom:4px; line-height:15px;font-family:"Myriad Pro", "Open Sans Cond Light", Arial;}
...
<s:iterator value="newsAndBlogsList">
               ...
               <div class="tab" style="margin-bottom:5px;">
                        ...
                        <s:if test="newsCategory== 'Energy_Meter'">
                         <div class="Category"><strong>Energy Meter</strong></div>
                        <div class="date"><strong><s:property value="date"/></strong></div>
                         
                         <div class="date-text" href="#">
                         
                        <p> <strong><s:property value="titleName"/></strong></p></div>
                        
                        
                     <s:property value="newsDescription" />
                     </s:if>
                     
                     
						 <s:elseif test="newsCategory== 'Company Events'">
					 <div class="Category"><strong>Company Events</strong></div>
							<div class="date"><strong><s:property value="date"/></strong></div>
                     ...
                     <s:property value="newsDescription" />
						...
						<s:elseif test="newsCategory== 'International News'">
					<div class="Category"><strong>International News</strong></div>
							<div class="date"><strong><s:property value="date"/></strong></div>
                     ...
                     <s:property value="newsDescription" />
						...
						<s:elseif test="newsCategory== 'Domestic News'">
					<div class="Category"><strong>Domestic News</strong></div>
							<div class="date"><strong><s:property value="date"/></strong></div>
                     ...
                     <s:property value="newsDescription" />
						...
						<s:elseif test="newsCategory== 'Technologies'">
					<div class="Category"><strong>Technologies </strong></div>
							<div class="date"><strong><s:property value="date"/></strong></div>
                     ...
                     <s:property value="newsDescription" />
								...
								<s:elseif test="newsCategory== 'Upcoming Events'">
					<div class="Category"><strong>Upcoming Events </strong></div>
							<div class="date"><strong><s:property value="date"/></strong></div>
                     ...
                     <s:property value="newsDescription" />
								...
								<s:elseif test="newsCategory== 'Competitive News'">
					<div class="Category"><strong>Competitive News </strong></div>
							<div class="date"><strong><s:property value="date"/></strong></div>
